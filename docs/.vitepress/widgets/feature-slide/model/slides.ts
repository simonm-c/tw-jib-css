...
export const slides: FeatureSlideData[] = [
  {
    headline: 'Gradient borders without the hacks.',
  ...
  {
    headline: 'Lighten, desaturate, rotate. Or all three.',
  ...
  {
    headline: 'CMYK dots and RGB pixels, faithfully reproduced.',
  ...
  {
    headline: 'Ripples on tap. Zero JavaScript.',
