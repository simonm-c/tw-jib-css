...
Full Tailwind color × shade × rotation matrix. Every swatch is labelled with a `data-test` attribute of the form `{family}-{shade}-{degrees}` for Playwright assertions.
...
## Color space modifiers, 120° on bg-red-500
