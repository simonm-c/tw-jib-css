...
<div class="h-screen w-screen fixed pointer-events-none inset-0 z-10 overflow-hidden">
  <div class="absolute top-0 bottom-0 w-[30%] -left-[20%] bg-[linear-gradient(to_right,transparent,rgba(255,255,255,0.1)_50%,transparent)] mix-blend-screen pointer-events-none animate-raster-retrace motion-reduce:hidden"></div>
     ...
     NAV
     ============================================================ -->
<nav class="sticky top-16 z-50 h-14 bg-pixel-stone-700 pixel-bloom-2 border-b border-stone-100/10 flex items-center justify-between px-8">
  ...
  <span class="bg-pixel-yellow-400 pixel-bloom-3 text-stone-100 font-silkscreen text-[15px] tabular-nums uppercase tracking-[0.06em] px-3 h-7 inline-flex items-center gap-2">
    <span class="w-2 h-2 bg-stone-950 animate-raster-live motion-reduce:animate-none"></span> LIVE DEMO
  </span>
</nav><!-- ============================================================
     HERO
     ============================================================ -->
<section class="relative min-h-[92vh] bg-pixel-blue-900 pixel-bloom-2 overflow-hidden">
  <div class="relative grid grid-cols-12 gap-6 max-w-[1440px] mx-auto px-16 pt-32 pb-20">
    <div class="col-span-12 md:col-span-8">
      ...
      <div class="flex flex-wrap gap-4 mt-10">
        <span class="bg-pixel-red-500 hover:bg-pixel-red-400 pixel-bloom-3 text-stone-100 font-departure text-[17px] uppercase tracking-[0.08em] h-12 px-8 inline-flex items-center cursor-pointer">
          Size dial →
        </span>
        <span class="bg-pixel-blue-700 pixel-bloom-2 text-stone-100 font-departure text-[17px] uppercase tracking-[0.08em] h-12 px-8 inline-flex items-center cursor-pointer hover:bg-pixel-blue-600">
          Bloom dial →
        </span>
      </div>
    </div>
    <article class="col-span-12 md:col-span-4 bg-pixel-fuchsia-800 pixel-bloom-3 text-stone-100 h-[520px] p-8 flex flex-col justify-between">
      <div>
     ...
     01 · PALETTE
     ============================================================ -->
<section class="border-t border-stone-100/10 bg-pixel-stone-800 pixel-bloom-2 py-12">
  <div class="max-w-[1440px] mx-auto px-8">
    <div class="mb-8">
      ...
      <div class="flex h-10 gap-[2px]">
        <div class="bg-pixel-red-600 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] px-2 flex items-center flex-3">-600</div>
        <div class="bg-pixel-red-500 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] px-2 flex items-center flex-4">-500</div>
        <div class="bg-pixel-red-700 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] px-2 flex items-center flex-3">-700</div>
      </div>      <span class="font-silkscreen text-[15px] text-stone-500 text-right tabular-nums">YELLOW</span>
      <div class="flex h-10 gap-[2px]">
        <div class="bg-pixel-yellow-500 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] px-2 flex items-center flex-5">-500</div>
        <div class="bg-pixel-yellow-600 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] px-2 flex items-center flex-5">-600</div>
      </div>      <span class="font-silkscreen text-[15px] text-stone-500 text-right tabular-nums">EMERALD</span>
      <div class="flex h-10 gap-[2px]">
        <div class="bg-pixel-emerald-500 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] px-2 flex items-center flex-4">-500</div>
        <div class="bg-pixel-emerald-700 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] px-2 flex items-center flex-6">-700</div>
      </div>      <span class="font-silkscreen text-[15px] text-stone-500 text-right tabular-nums">BLUE</span>
      <div class="flex h-10 gap-[2px]">
        <div class="bg-pixel-blue-600 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] px-2 flex items-center flex-7">-600</div>
        <div class="bg-pixel-blue-500 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] px-2 flex items-center flex-3">-500</div>
      </div>      <span class="font-silkscreen text-[15px] text-stone-500 text-right tabular-nums">FUCHSIA</span>
      <div class="flex h-10 gap-[2px]">
        <div class="bg-pixel-fuchsia-600 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] px-2 flex items-center flex-6">-600</div>
        <div class="bg-pixel-fuchsia-700 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] px-2 flex items-center flex-4">-700</div>
      </div>      <span class="font-silkscreen text-[15px] text-stone-500 text-right tabular-nums">CYAN</span>
      <div class="flex h-10 gap-[2px]">
        <div class="bg-pixel-cyan-500 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] px-2 flex items-center flex-3">-500</div>
        <div class="bg-pixel-cyan-700 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] px-2 flex items-center flex-7">-700</div>
      </div>
     ...
     02 · SIZE
     ============================================================ -->
<section class="bg-pixel-green-800 pixel-bloom-2">
  <div class="px-16 py-24 max-w-[1440px] mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mt-16">
     ...
     03 · CHANNELS
     ============================================================ -->
<section class="bg-pixel-stone-700 pixel-bloom-2">
  <div class="border-t border-stone-100/10 px-16 py-24 max-w-[1440px] mx-auto">
    ...
    <h2 class="font-departure font-black border-0 text-[52px] leading-[1.05] text-stone-100 mt-4 max-w-[38ch]">
      ...
      <article class="bg-pixel-red-500 pixel-bloom-2 text-stone-100 p-6 aspect-[2/3] flex flex-col justify-between">
      ...
      <article class="bg-pixel-yellow-400 pixel-bloom-2 text-stone-100 p-6 aspect-[2/3] flex flex-col justify-between">
      ...
      <article class="bg-pixel-emerald-500 pixel-bloom-2 text-stone-100 p-6 aspect-[2/3] flex flex-col justify-between">
      ...
      <article class="bg-pixel-blue-500 pixel-bloom-2 text-stone-100 p-6 aspect-[2/3] flex flex-col justify-between">
      ...
      <article class="bg-pixel-fuchsia-500 pixel-bloom-2 text-stone-100 p-6 aspect-[2/3] flex flex-col justify-between">
      ...
      <article class="bg-pixel-cyan-500 pixel-bloom-2 text-stone-100 p-6 aspect-[2/3] flex flex-col justify-between">
     ...
     04 · BLOOM
     ============================================================ -->
<section class="bg-pixel-rose-950 pixel-bloom-2">
  <div class="border-t border-stone-100/10 px-16 py-24 max-w-[1440px] mx-auto">
    <p class="font-silkscreen text-[14px] uppercase tracking-[0.08em] text-stone-400 m-0">
      // 04 · BLOOM
    </p>
    <h2 class="font-departure font-black border-0 text-[52px] md:text-[60px] leading-[1.05] text-stone-100 mt-4 max-w-[32ch]">
      Columns spread. Seams blend. Color saturates.
     ...
     05 · CHIPS
     ============================================================ -->
<section class="bg-pixel-stone-600 pixel-bloom-2">
  <div class="border-t border-stone-100/10 px-16 py-24 max-w-[1440px] mx-auto">
    <p class="font-silkscreen text-[14px] uppercase tracking-[0.08em] text-stone-400 m-0">
      // 05 · CHIPS
    </p>
    <h2 class="font-departure font-black border-0 text-[52px] leading-[1.05] text-stone-100 mt-4 max-w-[36ch]">
      ...
      <article class="bg-pixel-stone-800 pixel-bloom-2 border border-stone-100/10 p-8">
        <span class="bg-pixel-fuchsia-600 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] uppercase tracking-[0.08em] px-3 h-6 inline-flex items-center">
          fuchsia · 600
        </span>
      ...
      <article class="bg-pixel-stone-800 pixel-bloom-2 border border-stone-100/10 p-8">
        <span class="bg-pixel-emerald-600 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] uppercase tracking-[0.08em] px-3 h-6 inline-flex items-center">
          emerald · 600
        </span>
        <h3 class="font-departure font-black border-0 text-[34px] leading-[1.1] text-stone-100 mt-6">
      ...
      <article class="bg-pixel-stone-800 pixel-bloom-2 border border-stone-100/10 p-8">
        <span class="bg-pixel-yellow-500 pixel-bloom-2 text-stone-100 font-silkscreen text-[14px] uppercase tracking-[0.08em] px-3 h-6 inline-flex items-center">
          yellow · 500
        </span>
        <h3 class="font-departure font-black border-0 text-[34px] leading-[1.1] text-stone-100 mt-6">
     ...
     06 · FORM
     ============================================================ -->
<section class="bg-pixel-cyan-800 pixel-bloom-2">
  <div class="px-16 py-24">
    <div class="max-w-[640px] mx-auto mb-8">
    ...
    </div>    <div class="max-w-[640px] mx-auto border border-stone-100/15 bg-pixel-stone-800 pixel-bloom-2 relative">
      <div class="absolute top-0 left-0 right-0 flex h-1">
        <div class="flex-1 bg-pixel-red-500 pixel-bloom-2"></div>
        <div class="flex-1 bg-pixel-yellow-400 pixel-bloom-2"></div>
        <div class="flex-1 bg-pixel-emerald-500 pixel-bloom-2"></div>
        <div class="flex-1 bg-pixel-blue-500 pixel-bloom-2"></div>
      </div>
      <div class="p-10 pt-12">
        <form class="flex gap-3" onsubmit="event.preventDefault()">
          <input type="email" placeholder="flat input · no texture" aria-label="Email address" class="flex-1 bg-pixel-stone-900 pixel-bloom-2 border border-stone-100/20 text-stone-100 caret-stone-100 font-departure text-[18px] px-4 h-12 outline-none focus:border-stone-100"/>
          <button type="submit" class="bg-pixel-red-500 hover:bg-pixel-red-400 pixel-bloom-3 text-stone-100 font-departure text-[17px] uppercase tracking-[0.08em] h-12 px-6">Submit →</button>
        </form>
      </div>
    </div>
  </div>
     ...
     FOOTER
     ============================================================ -->
<footer class="border-t bg-pixel-orange-900 pixel-bloom-2 border-stone-100/10 px-16 py-14">
...
<div class="bg-pixel-stone-900 pixel-bloom-2 h-6 flex items-center justify-center">
