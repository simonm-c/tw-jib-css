...
<!-- llm-context: CMYK halftone dot backgrounds derived from any Tailwind color. Splits the color into overlapping cyan, magenta, yellow and black dot layers with CSS relative color syntax and radial gradients, composited with multiply for subtractive mixing. -->
...
<Example>
  <div class="flex gap-3">
    <div class="space-y-1.5">
      <div class="bg-comic-blue-500 comic-gap-0 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">gap-0</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-blue-500 comic-gap-1 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">gap-1</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-blue-500 comic-gap-2 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">gap-2</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-blue-500 comic-gap-4 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">gap-4</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-blue-500 comic-gap-8 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">gap-8</p>
    </div>
  </div>
</Example>
...
<Example>
  <div class="flex gap-3">
    <div class="space-y-1.5">
      <div class="bg-comic-red-500 comic-dot-0.5 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">dot-0.5</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-red-500 comic-dot-1 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">dot-1</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-red-500 comic-dot-1.5 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">dot-1.5</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-red-500 comic-dot-2 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">dot-2</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-red-500 comic-dot-3 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">dot-3</p>
    </div>
  </div>
</Example>
...
<Example>
  <div class="flex gap-3">
    <div class="space-y-1.5">
      <div class="bg-comic-red-500 comic-bleed-0 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">bleed-0</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-red-500 comic-bleed-1 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">bleed-1</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-red-500 comic-bleed-2 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">bleed-2</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-red-500 comic-bleed-3 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">bleed-3</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-red-500 comic-bleed-4 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">bleed-4</p>
    </div>
  </div>
</Example>
...
<Example>
  <div class="flex gap-3">
    ...
    <div class="space-y-1.5">
      <div class="bg-comic-red-500/75 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">/75</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-red-500/50 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">/50</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-red-500/25 size-24 rounded-lg"></div>
      <p class="m-0 text-center text-xs font-mono opacity-60">/25</p>
    </div>
    <div class="space-y-1.5">
      <div class="bg-comic-red-500/10 size-24 rounded-lg"></div>
...
<Example stretch label="comic · press sheet">
  <div class="bg-comic-[#f4ead0] p-3 font-bold text-neutral-900">
    <div class="bg-comic-[#c62828] relative aspect-[21/9] overflow-hidden border-4 border-neutral-900">
      <div class="absolute top-4 left-4 font-bowlby text-[26px] leading-[0.95] uppercase text-white drop-shadow-[3px_3px_0] drop-shadow-neutral-900">Four inks.<br/>One press.<br/>No images.</div>
      <div class="bg-comic-[#f6df6b] absolute top-3 right-3 max-w-[22ch] border-2 border-neutral-900 px-2 py-1 font-comic text-[11px] leading-[1.3] uppercase">This red is yellow and magenta dots. Nothing here is a photograph.</div>
      <div class="absolute right-4 bottom-3 bg-comic-[#f6df6b] bg-clip-text font-bowlby text-[52px] leading-[0.85] tracking-tight uppercase text-transparent drop-shadow-[4px_4px_0] drop-shadow-neutral-900">Krakk!</div>
      <div class="bg-comic-[#f6df6b] absolute bottom-3 left-4 border-2 border-neutral-900 px-1.5 py-0.5 font-comic text-[10px] leading-none uppercase">Fig. 01 · bg-comic-[#c62828]</div>
    </div>
    <div class="mt-3 grid grid-cols-5 gap-2">
      <div class="bg-comic-neutral-100 aspect-[3/2] border-2 border-neutral-900" title="comic-neutral-100"></div>
      <div class="bg-comic-neutral-300 aspect-[3/2] border-2 border-neutral-900" title="comic-neutral-300"></div>
      <div class="bg-comic-neutral-500 aspect-[3/2] border-2 border-neutral-900" title="comic-neutral-500"></div>
      <div class="bg-comic-neutral-700 aspect-[3/2] border-2 border-neutral-900" title="comic-neutral-700"></div>
      <div class="bg-comic-neutral-900 aspect-[3/2] border-2 border-neutral-900" title="comic-neutral-900"></div>
    </div>
    <div class="mt-2 font-comic text-[11px] leading-[1.3] uppercase">Fig. 02 · the issue goes to press in black and white. Same ink, no hue — dot coverage carries the tone.</div>
  </div>
</Example>
