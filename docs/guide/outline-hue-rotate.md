...
Formulas use `amt` for `var(--tw-jib--outline-hue--amount)`. In oklab/lab, trig rotation: `cos(amt * 1deg)`, `sin(amt * 1deg)`. RGB uses a 3×3 luma-preserving matrix (0.213, 0.715, 0.072).

<QuickReference :rows="[
  { class: 'outline-hue-rotate-<deg>', styles: 'outline-color: oklch(from var(--tw-jib--outline-color) l c calc(h + amt) / alpha)' },
  { class: '-outline-hue-rotate-<deg>', styles: 'outline-color: oklch(from var(--tw-jib--outline-color) l c calc(h + amt) / alpha)' },
  { class: 'outline-hue-rotate-<deg>/oklch', styles: 'outline-color: oklch(from var(--tw-jib--outline-color) l c calc(h + amt) / alpha)' },
  { class: 'outline-hue-rotate-<deg>/hsl', styles: 'outline-color: hsl(from var(--tw-jib--outline-color) calc(h + amt) s l / alpha)' },
  { class: 'outline-hue-rotate-<deg>/lab', styles: 'outline-color: lab(from var(--tw-jib--outline-color) l calc(a * cos(amt * 1deg) - b * sin(amt * 1deg)) calc(a * sin(amt * 1deg) + b * cos(amt * 1deg)) / alpha)' },
  { class: 'outline-hue-rotate-<deg>/rgb', styles: 'outline-color: rgb(from var(--tw-jib--outline-color) calc(r*(.213+.787*cos) + g*(.715-.715*cos-.715*sin) + b*(.072-.072*cos+.928*sin)) calc(r*(.213-.213*cos+.143*sin) + g*(.715+.285*cos+.140*sin) + b*(.072-.072*cos-.283*sin)) calc(r*(.213-.213*cos-.787*sin) + g*(.715-.715*cos+.715*sin) + b*(.072+.928*cos+.072*sin)) / alpha)' },
]" />
