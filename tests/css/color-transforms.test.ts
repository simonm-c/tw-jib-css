...
const STABLE_OKLCH = `oklch(from ${BG_LIGHT_INPUT} calc(l * (1 - abs(var(--tw-jib--background-lightness--amount))) + max(0, var(--tw-jib--background-lightness--amount))) calc(c * min(1, (1 - abs(var(--tw-jib--background-lightness--amount))) * 5)) h / alpha)`;
